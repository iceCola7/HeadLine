...
public class NewsMultiArticleDataBean implements Parcelable {

    public static final Creator<NewsMultiArticleDataBean> CREATOR = new Creator<NewsMultiArticleDataBean>() {
        @Override
        public NewsMultiArticleDataBean createFromParcel(Parcel in) {
            return new NewsMultiArticleDataBean(in);
        }

        @Override
        public NewsMultiArticleDataBean[] newArray(int size) {
            return new NewsMultiArticleDataBean[size];
        }
    };
    /**
    ...
    public NewsMultiArticleDataBean() {
    }

    protected NewsMultiArticleDataBean(Parcel in) {
...
//    }
    ...
    public String toString() {
        return "NewsMultiArticleDataBean{" +
                "log_pb=" + log_pb +
